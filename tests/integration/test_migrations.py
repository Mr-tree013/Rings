...
def test_upgrade_adds_the_observation_tables(tmp_path: Path, clock: FakeClock) -> None:
    ...
    assert [migration.version for migration in applied] == ["0015", "0016", "0017"]
    assert {
        "web_watch_state",
        "web_observations",
...
def test_upgrade_adds_the_playbook_tables(tmp_path: Path, clock: FakeClock) -> None:
    ...
    assert [migration.version for migration in applied] == ["0014", "0015", "0016", "0017"]
    assert {
        "playbook_candidates",
...
def test_upgrade_adds_the_learning_tables(tmp_path: Path, clock: FakeClock) -> None:
    ...
    assert [migration.version for migration in applied] == ["0013", "0014", "0015", "0016", "0017"]
